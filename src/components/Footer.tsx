  ...
  return (
    <footer className="relative flex flex-col items-center justify-end">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center justify-between gap-8 px-8 py-12 md:flex-row md:px-[var(--nav-edge-w)] md:py-20">
        <p className="font-syne text-2xl leading-9 text-[rgba(253,251,246,0.7)] md:text-[30px]">
          Athar El Hakim
        </p>
        <nav className="flex flex-wrap items-center justify-center gap-4">
          <Link
            to="/"
            className="flex items-center justify-center rounded-full px-3 py-1.5 text-base leading-6 text-[#fdfbf6] transition-colors duration-300 hover:bg-white/10"
          >
            Home
          </Link>
          <Link
      ...
      <div className="flex w-full items-center justify-center py-2">
        <p className="whitespace-nowrap text-base leading-5 text-[rgba(253,251,246,0.5)]">
          © 2026 Athar El Hakim
        </p>
      </div>
    </footer>
